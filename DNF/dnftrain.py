...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch-size', type=int, default=16, help='input batch size for training (default: 300)')
    ...
    parser.add_argument('--n_filter', type=int, default=100, help='dryrun a small number of classes (default: 0)')
    parser.add_argument('--vc', type=float, default=2, help='variance of the class space (default: 1.0)')
    ...
    # load data
    print("loading data ...")
    root = '/home/daip/share/old_share/wxf/feature/DNF/tea/densenet/'
    backboon_name = 'densenet_tea_pre'
    train_path = '/home/daip/share/old_share/wxf/feature/feature/tea/densenet/desFeature_tea_train_pre.npz'
    test_path = '/home/daip/share/old_share/wxf/feature/feature/tea/densenet/desFeature_tea_test_pre.npz'
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
                ...
                # print("epoch",model)
                label0 = np.load(train_path)['utt']-1
                ...
                label2 = np.load(test_path)['utt']-1
